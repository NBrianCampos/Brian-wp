                                    ...
                                    <div class="exad-demo-previewer-item-content-inner <?php echo $gallery['exad_demo_previewer_enable_content_btn']; ?>">
                                        ...
                                        <?php
                                            if( !empty( $gallery['exad_demo_previewer_item_title'] ) ) { ?>
                                                <h6 class="exad-demo-previewer-item-content-title"><a href="<?php echo $gallery['exad_demo_previewer_item_title_url']['url']; ?>"<?php echo  $target . $nofollow; ?>><?php echo $gallery['exad_demo_previewer_item_title']; ?></a></h6>
                                            <?php }
