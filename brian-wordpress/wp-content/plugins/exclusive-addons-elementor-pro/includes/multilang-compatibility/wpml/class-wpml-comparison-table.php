...
class WPML_Exad_Comparison_Table extends WPML_Elementor_Module_With_Items {
	...
	public function get_fields() {
		return [ 'exad_table_heading_col', 'exad_table_heading_currency_symbol', 'exad_table_heading_current_price',  'exad_table_heading_regular_price', 'exad_table_heading_duration', 'exad_table_heading_ribbon_text', 'exad_table_body_text', 'exad_table_body_tooltip_text', 'exad_table_body_button_text', 'exad_table_body_row_id_class'];
	}
